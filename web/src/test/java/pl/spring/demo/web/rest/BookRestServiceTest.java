...
public class BookRestServiceTest {
    ...
    public void testShouldCallBookService() throws Exception {
        ...
        final BookTo bookTo1 = new BookTo(1L, bookTitle, new HashSet<AuthorTo>(Arrays.asList(new AuthorTo(1L,"Author1","Author1"))));
        final BookTo bookTo2 = new BookTo(2L, bookTitle, new HashSet<AuthorTo>(Arrays.asList(new AuthorTo(2L,"Author2","Author2"))));
        ...
        response.andExpect(status().isOk())
                ...
                .andExpect(jsonPath("[0].authors").value("{\"firstName\":\"Author1\",\"lastName\":\"Author1\",\"id\":1}"))
